...
public class Main {
	...
	private static void uploadMovies(Scanner in, Netflix n) {
		...
		for( int i = 0; i < nMovie; i++ ) {
			...
			int nCastMov = in.nextInt(); in.nextLine();
	...
	private static void uploadTvShows(Scanner in, Netflix n) {
		...
		for( int i = 0; i < nSeries; i++ ) {
			...
			int nCastSeries = in.nextInt(); in.nextLine();
	 ...
	 */
	private static <E> void printIterator(Iterator<E> it) {		// TODO check utility by the end
		while (it.hasNext())
